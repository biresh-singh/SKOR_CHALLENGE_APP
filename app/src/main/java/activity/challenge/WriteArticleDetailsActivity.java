...
public class WriteArticleDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_funniest_article_details);
        initView();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tvCheckIn:
                startActivity(new Intent(this,WriteFunArticleChallengeActivity.class));
                break;
            case R.id.btnBack:
                    finish();
                break;
    ...
    private void showCongratulationPopup(Activity context) {
        ...
        tvBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent intent = new Intent(WriteArticleDetailsActivity.this, MainActivity.class);
                intent.putExtra("screen", "individual");
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
                finish();
