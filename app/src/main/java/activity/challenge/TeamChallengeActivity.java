...
import fragment.challenge.ProceedTeamChallengeFragment;
...
public class TeamChallengeActivity extends FragmentActivity implements NavigationDeleget, View.OnClickListener {
    ...
    private void initView() {
        ...
        displayView(Constants.TakeTeamChallengeFragment,null);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnBack:
                ...
                if (currentFragment instanceof ProceedTeamChallengeFragment) {
                    displayView(Constants.TakeTeamChallengeFragment, null);
                }
                else
                {
    ...
    public void displayView(String fragmentName, Object obj) {
        ...
        if (fragmentName.equalsIgnoreCase(Constants.TakeTeamChallengeFragment)) {
            mFragment = new TakeTeamChallengeFragment(mContext,challengetype,clng,rewards);
        } else if (fragmentName.equalsIgnoreCase(Constants.ProceedTeamChallengeFragment)) {
            mFragment = new ProceedTeamChallengeFragment(mContext,challengetype,clng);
        }

        if (mFragment != null) {
            try {
                if (fragmentName.equals(Constants.TakeTeamChallengeFragment)) {
                    fragmentTransaction.replace(R.id.challengeContainer, mFragment);
                    fragmentTransaction.commit();
                } else if (fragmentName.equals(Constants.ProceedTeamChallengeFragment)) {
