...
public class FeedFeaturedBookmarkResponse extends RealmObject{
    @PrimaryKey
    String id;
    ...
    public FeedFeaturedBookmarkResponse() {

    }

    public FeedFeaturedBookmarkResponse(JSONObject jsonObject) {
            ...
            if (jsonObject.has("results")) {
                if (jsonArray.length() != 0) {
                    for (int i=0; i<jsonArray.length(); i++) {
                        ...
                        feedFeaturedRealmList.add(feedFeatured);
                    }
                }
            }
