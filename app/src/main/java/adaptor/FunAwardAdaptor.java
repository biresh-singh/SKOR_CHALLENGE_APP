...
public class FunAwardAdaptor extends RecyclerView.Adapter<FunAwardAdaptor.MyFunAwardAdaptor> {
    private Context mContext;
    private List<Participants> mParticipantsList;
    public FunAwardAdaptor(Context context) {
        this.mContext = context;
    }

    @Override
    public MyFunAwardAdaptor onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_fun_award_item, parent, false);
    ...
    public static class MyFunAwardAdaptor extends RecyclerView.ViewHolder{
        RobotoBoldTextView tvName,tvDepartment;
        CircleImageView userimage;
        public MyFunAwardAdaptor(View itemView) {
            super(itemView);
            tvName = (RobotoBoldTextView) itemView.findViewById(R.id.tvName);
            tvDepartment = (RobotoBoldTextView) itemView.findViewById(R.id.tvDepartment);
