...
public class TakeChallengeFragment extends Fragment implements View.OnClickListener{
    ...
    public TakeChallengeFragment(Context context, String challengetype, Challenge mChallenge, Rewards mRewards) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_take_challenge, container, false);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        ...
        tvChallengeDays= (TextView) view.findViewById(R.id.tvChallengeDays);
        tvChallengeExpires= (TextView) view.findViewById(R.id.tvChallengeExpires);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.tvTakeChallenge:
                mNavigationDeleget.executeFragment(Constants.ProceedChallengeFragment,null);
                break;
        }
