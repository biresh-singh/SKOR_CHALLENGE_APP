...
import adaptor.LeaderBoardIndividualFragmentAdaptor;
...
public class LeaderBoardIndividualFragment extends Fragment {
    ...
    ArrayList<LeaderBoardItemIndividual> arrayListleaderBoardIndividual = new ArrayList<>();
    LeaderBoardItemIndividual leaderBoardItem;
    LeaderBoardIndividualFragmentAdaptor leaderBoardBusinessAdaptor;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.leaderboard_individual_activity, null);
        ...
        listviewList = (ListView) rootView.findViewById(R.id.leaderboard_recyclerview);
    ...
    /* ******************calling individual leaderboard Api to get method****************************/

    public void callLeaderBoardIndividualApi() {
        ...
        client.get(url, params, new JsonHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                if (statusCode > 401 && statusCode <= 499) {
                    ...
                    if (coordinatorLayout != null) {
                        Snackbar snackbar = Snackbar.make(coordinatorLayout, "Unable to log in with provided credentials.", Snackbar.LENGTH_LONG);
                        View snackBarView = snackbar.getView();
                        snackBarView.setBackgroundColor(Color.RED);
                        snackbar.show();
    ...
    public void onResume() {
        super.onResume();
        AppController.getInstance().getMixpanelAPI().track("IndividualLeaderboardViewed");
    }

    public void updateUI(String jsonresponse) {
        try {
            JSONObject jsonObject = new JSONObject(jsonresponse);
            headerBussinessText.setText("Your Individual Rank is " + jsonObject.getString("user_rank"));
            JSONArray departmentJsonArray = jsonObject.getJSONArray("ranked_users");
            for (int i = 0; i < departmentJsonArray.length(); i++) {
                ...
                firstName = departmentJsonObject.getString("first_name");
                imageUrl = departmentJsonObject.getString("thumbnail_image_url");
                leaderBoardItem = new LeaderBoardItemIndividual(totalPoints, pk, firstName, imageUrl);
                arrayListleaderBoardIndividual.add(leaderBoardItem);
            }
            if (getActivity() != null) {
                leaderBoardBusinessAdaptor = new LeaderBoardIndividualFragmentAdaptor(getActivity(), arrayListleaderBoardIndividual);
